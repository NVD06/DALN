...
@section('content')
    <div class="container">
        ...
        <form method="GET" action="{{ route('courses.index') }}" class="my-4 d-flex justify-content-center">
            <input type="text" name="search" class="form-control w-50 me-2" placeholder="Tìm kiếm khóa học..."
        ...
        <div class="tab-content">
            ...
            <div id="ongoingCourses" class="tab-pane fade">
                @php
                    $ongoingCourses = $courses->filter(
                        fn($course) => $course->isRegistered(Auth::id()) && $course->getProgress(Auth::id()) < 100,
                    );
                @endphp
